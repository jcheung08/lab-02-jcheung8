...
int parse_request( char* http_request ) {
  if (http_request[0] == 'G' && http_request[1] == 'E' && http_request[2] == 'T' && http_request[3] == '\0') {
    return 0;
  }
  if (http_request[0] == 'P' && http_request[1] == 'O' && http_request[2] == 'S' && http_request[3] =='T' && http_request[4] == ' ') {
    return 1;
  }
